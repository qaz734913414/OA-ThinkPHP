    ...
    <div id="hd">
      <div class="hd-wrap ue-clear">
        ...
        <div class="login-info ue-clear">
          <div class="welcome ue-clear" style='width:auto'>
            <span>欢迎您,&nbsp;</span>
            <a href="javascript:;" class="user-name"><?php echo (session('username')); ?>&nbsp;(<?php echo ($mac); ?>)</a>
          ...
          <ul class="nav">
            ...
            <li class="gongwen">
              ...
              <ul class="subnav">
                ...
                <li><a href="javascript:;" date-src="/index.php/Admin/Doc/add">公文起草</a></li>
              </ul>
            </li>
            <li class="nav-info">
            ...
            <li class="agency">
              ...
              <ul class="subnav">
                ...
                <li><a href="javascript:;" date-src="/index.php/Admin/Dept/add">添加部分</a></li>
              </ul>
            </li>
            <li class="email">
