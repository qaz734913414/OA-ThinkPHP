        ...
        <div class="main">
           ...
           <div class="short-input select ue-clear">
               ...
               <select name="dept_id">
                   ...
                   <?php if(is_array($dept)): $i = 0; $__LIST__ = $dept;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"<?php if($vo["id"] == $data["dept_id"] ): ?>selected='selected'<?php endif; ?> >
                        <?php echo (str_repeat('&emsp;',$vo["level"]*2)); echo ($vo["name"]); ?>
